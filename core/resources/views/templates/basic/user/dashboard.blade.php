                            ...
                            <div class="col-xxl-3 col-sm-6 col-xsm-6">
                                <div class="dashboard-widget flex-align style-warning">
                                    ...
                                    <div class="dashboard-widget__content">
                                        <span class="dashboard-widget__text">Mature Bond</span>
                                        <h4 class="dashboard-widget__number">05</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-sm-6 col-xsm-6">
                                <div class="dashboard-widget flex-align style-success">
                                    ...
                                    <div class="dashboard-widget__content">
                                        <span class="dashboard-widget__text">Invest Amount</span>
                                        <h4 class="dashboard-widget__number">$45,000</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-sm-6 col-xsm-6">
                                <div class="dashboard-widget flex-align style-primary">
                                    ...
                                    <div class="dashboard-widget__content">
                                        <span class="dashboard-widget__text">Total Bond</span>
                                        <h4 class="dashboard-widget__number">5,000</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-sm-6 col-xsm-6">
                                <div class="dashboard-widget flex-align style-pink">
                                    <a href="#" class="link-to-go"></a>
                                    <div class="dashboard-widget__icon flex-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" viewBox="0 0 64 64" style="enable-background: new 0 0 512 512"
                                            xml:space="preserve" class="">
                                            <g>
                                                <path
                                                    d="M61.305 44.014a5.457 5.457 0 0 0-6.335-2.59l-15.551 4.57a7.095 7.095 0 0 0-4.972-5.54l-10.142-3.051a.992.992 0 0 0-.61.01l-9.441 3.207v-2.26a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v19.392a1 1 0 0 0 1 1h10.254a1 1 0 0 0 1-1v-1.514c4.838 1.542 20.158 5.542 20.882 5.73.219.058.452.039.659-.053l7.683-3.422a1 1 0 1 0-.815-1.827l-7.362 3.279c-5.365-1.402-18.093-4.784-21.047-5.81V42.733l9.781-3.322 9.836 2.958a5.1 5.1 0 0 1 3.635 4.558c-.785.747-3.44 2.768-8.46 1.774a.997.997 0 0 0-1.174.786 1 1 0 0 0 .786 1.176c1.09.216 2.092.308 3.006.308 4.328 0 6.707-2.059 7.419-2.794l16.45-4.833a3.47 3.47 0 0 1 4.026 1.645 3.45 3.45 0 0 1 .261 2.798 3.446 3.446 0 0 1-1.887 2.08l-11.77 5.242a1 1 0 1 0 .814 1.827l11.77-5.242c1.402-.625 2.485-1.818 2.97-3.275s.336-3.062-.412-4.404zM12.254 56.752H4V39.36h8.254z"
                                                    opacity="1" data-original="#000000" class=""></path>
                                                <path
                                                    d="M7.168 43.322h1.918a1 1 0 1 0 0-2H7.168a1 1 0 1 0 0 2zM53.693 18.001c0 4.312-1.386 8.418-3.914 11.837l.06-.797a1 1 0 0 0-.922-1.072.996.996 0 0 0-1.072.922l-.287 3.817a1 1 0 0 0 .921 1.072l3.818.287a1 1 0 0 0 .15-1.994l-1.756-.132a21.838 21.838 0 0 0 5.002-13.94c0-5.957-2.35-11.539-6.62-15.717a1.001 1.001 0 0 0-1.398 1.43c3.88 3.798 6.018 8.872 6.018 14.287z"
                                                    opacity="1" data-original="#000000" class=""></path>
                                                <path
                                                    d="M18.693 19.001a1 1 0 0 0 1-1c0-7.72 6.28-14 14-14s14 6.28 14 14-6.28 14-14 14c-6.366 0-11.936-4.296-13.545-10.447a1 1 0 0 0-1.936.506c1.84 7.03 8.206 11.941 15.481 11.941 8.823 0 16-7.178 16-16s-7.177-16-16-16-16 7.178-16 16a1 1 0 0 0 1 1z"
                                                    opacity="1" data-original="#000000" class=""></path>
                                                <path
                                                    d="M33.693 24.83a2.918 2.918 0 0 1-2.915-2.914 1 1 0 1 0-2 0 4.922 4.922 0 0 0 3.915 4.811v1.274a1 1 0 1 0 2 0v-1.274a4.922 4.922 0 0 0 3.915-4.811 4.92 4.92 0 0 0-4.915-4.915c-1.607 0-2.915-1.308-2.915-2.915s1.308-2.914 2.915-2.914 2.915 1.308 2.915 2.914a1 1 0 1 0 2 0 4.922 4.922 0 0 0-3.915-4.81V8a1 1 0 1 0-2 0v1.274a4.922 4.922 0 0 0-3.915 4.811 4.92 4.92 0 0 0 4.915 4.915 2.918 2.918 0 0 1 2.915 2.915 2.918 2.918 0 0 1-2.915 2.915z"
                                                    opacity="1" data-original="#000000" class=""></path>
                                            </g>
                                        </svg>
                                    </div>
